...
##TAGS used
1. marker of ending a feuilleton or any other novel subdivision (part): "<trailer>(Va urma).</trailer>";
  "<trailer>FINE</trailer>";
2. title of the journal where the feuilleton was published in feuilleton header: "<head>FOILETONUL ZIARULUI „MINERVA”</head>"
3. number of the feuilleton in feuilleton header: "<head>87</head>"
4. title of the novel in feuilleton header: "<head>NOI SUNTEM SCLAVE. ROMAN MODERN</head>"
5. name of the author in feuilleton header:    "<head>de Vasile Pop</head>"
